...
$MESS["T_IBLOCK_DESC_IBORD1"] = "Поле для первой сортировки пользователей";
$MESS["T_IBLOCK_DESC_IBBY1"] = "Направление для первой сортировки пользователей";
$MESS["T_IBLOCK_DESC_IBORD2"] = "Поле для второй сортировки пользователей";
$MESS["T_IBLOCK_DESC_IBBY2"] = "Направление для второй сортировки пользователей";
$MESS["T_IBLOCK_DESC_IBORD3"] = "Поле для третьей сортировки пользователей";
$MESS["T_IBLOCK_DESC_IBBY3"] = "Направление для третьей сортировки пользователей";
...
$MESS["T_IBLOCK_DESC_LIST_CONT"] = "Количество пользователей на странице";
...
$MESS["T_DESC_RESIZE_PERSONAL_PHOTO"] = "Уменьшить размер персональной картинки (ширина*высота)";
$MESS["T_DESC_RESIZE_WORK_LOGO"] = "Уменьшить размер логотипа работы (ширина*высота)";
$MESS["T_DESC_RESIZE_TYPE"] = "Тип уменьшения картинки";
$MESS["T_DESC_BX_RESIZE_IMAGE_EXACT"] = "Обрезать по заданым размерам";
$MESS["T_DESC_BX_RESIZE_IMAGE_PROPORTIONAL"] = "Масштабировать с сохранением пропорций";
$MESS["T_DESC_BX_RESIZE_IMAGE_PROPORTIONAL_ALT"] = "Масштабировать с сохранением пропорций (улучшенная обработка вертикальных картинок)";
?>