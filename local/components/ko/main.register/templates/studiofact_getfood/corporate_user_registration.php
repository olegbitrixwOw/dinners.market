...
<?foreach ($arResult["SHOW_FIELDS"] as $FIELD):?>
	...
	<?else:?>
		<tr>
			<td>
				<p><?if ($FIELD == "NAME"):?>
					<?=GetMessage("REGISTER_FIELD_NAME_CORPORATE")?>
					<?elseif ($FIELD == "LAST_NAME"):?>
					<?=GetMessage("REGISTER_FIELD_LAST_NAME_CORPORATE")?>
					<?elseif ($FIELD == "SECOND_NAME"):?>
					<?=GetMessage("REGISTER_FIELD_SECOND_NAME_CORPORATE")?>
				<?else:?>
...
<tr>
			...
			<script type="text/html" data-bx-template="main-user-consent-request-loader">
				...
				<input type="hidden" name="USER_TAB" value="corporate">
				<input type="hidden" name="UF_USER_TYPE" value="<?=USER_TYPE_MANAGER?>">	
				<!-- <input type="hidden" name="REGISTER[ACTIVE]" value="N" /> -->
			</td>
		</tr>
	</tbody>
	<tfoot>
