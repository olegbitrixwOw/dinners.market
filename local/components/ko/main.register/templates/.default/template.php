...
<!-- <form method="post" action="/firm/workers/?ELEMENT_ID=<?=intval($_REQUEST['firm_id'])?>" name="regform" enctype="multipart/form-data"> -->
...
?>
	...
	<tfoot>
		<tr>
			<td><input type="hidden" name="UF_GILD" value="<?=intval($_REQUEST['firm_id'])?>"></td>
