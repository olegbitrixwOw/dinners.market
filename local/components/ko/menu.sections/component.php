	...
	else
	{
		...
		while($arSection = $rsSections->GetNext())
		{
			...
			$arResult["SECTIONS"][] = array(
				...
				"MENU_PICTURE" => $arSection["UF_MENU_PICTURE"],
				"MENU_PICTURE_HOVER" => $arSection["UF_MENU_PICTURE_HOVER"],
				"MENU_CLASS_CSS" => $arSection["UF_MENU_CLASS_CSS"]
			);
...
foreach($arResult["SECTIONS"] as $key => $arSection)
{
	...
	// $arResult["ELEMENT_LINKS"][$arSection["ID"]]["MENU_PICTURE"]=$arSection["MENU_PICTURE"];
	// $arResult["ELEMENT_LINKS"][$arSection["ID"]]["MENU_PICTURE_HOVER"]=$arSection["MENU_PICTURE_HOVER"];
	// $arResult["ELEMENT_LINKS"][$arSection["ID"]]["MENU_CLASS_CSS"]=$arSection["MENU_CLASS_CSS"];

	if($key == 0){
		$params = array("FROM_IBLOCK" => true, "IS_PARENT" => false, "DEPTH_LEVEL" => $arSection["DEPTH_LEVEL"],
			"MENU_PICTURE" => $arSection["MENU_PICTURE"], "MENU_PICTURE_HOVER" => $arSection["MENU_PICTURE_HOVER"],
			"MENU_CLASS_CSS" => $arSection["MENU_CLASS_CSS"], "CUISINE_PARAMS" => $arParams["CUISINE_PARAMS"]
		);
	}else{
		$params = array(
			"FROM_IBLOCK" => true,"IS_PARENT" => false,"DEPTH_LEVEL" => $arSection["DEPTH_LEVEL"],
			"MENU_PICTURE" => $arSection["MENU_PICTURE"],"MENU_PICTURE_HOVER" => $arSection["MENU_PICTURE_HOVER"],
			"MENU_CLASS_CSS" => $arSection["MENU_CLASS_CSS"]
		);
	}
