...
CBitrixComponent::includeComponentClass("alex:sale.order.payment.change");

$orderPayment = new SaleOrderPaymentChange();
$orderPayment->initComponent('alex:sale.order.payment.change');
