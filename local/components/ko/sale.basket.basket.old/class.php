...
class SaleBasketLineComponentOLd extends CBitrixComponent 
{
	...
	protected function removeItemFromCart()
	{
		...
		$numProducts = Sale\Internals\BasketTable::getList(array(
		    'filter' => array(
		...
		// echo $_POST['sbblRemoveItemFromCart'];
	}
	...
	private function getProducts()
	{
		...
		$fullBasket = $basketClass::loadItemsForFUser($currentFuser, $this->day_week); 
	...
	protected function getBasketStorage()
	{
		if (!isset($this->basketStorage))
		{
			...
			$this->basketStorage = Sale\Basket\Storage::getInstance($this->getFuserId(), $this->day_week); 
