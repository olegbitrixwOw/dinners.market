...
if (isset($_REQUEST['day_week']) && is_string($_REQUEST['day_week']))
{
	$day_week = trim($_REQUEST['day_week']);
	if ($day_week !== '' && preg_match('/^[a-z0-9_]{2}$/i', $day_week) === 1)
	{
