...
<?if($arResult["UF_LIMIT"]):?>
	<tr>
		<td>Лимит<?if($arResult["UF_LIMIT"]):?><span class="starrequired">*</span><?endif?></td>
		<td><input type="text" name="UF_LIMIT" maxlength="50" value="<? echo $arResult["arUser"]["UF_LIMIT"]?>" /></td>
	</tr>
<?endif?>
