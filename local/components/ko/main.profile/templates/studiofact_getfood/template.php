...
<table class="profile-table data-table">
	...
	<tr>
		<td>Телефон</td>
		<td><input type="text" name="PERSONAL_PHONE"  maxlength="255" data-input="phone" value="<?=$arResult["arUser"]["PERSONAL_PHONE"]?>" /></td>
	</tr>
...
<?endif?>
		...
		<?if($arResult["DELIVERY"]):?>
				<tr>
					<td class="field-name" style="padding:20px 0;">Адрес доставки</span></td>
					<td class="field-value" style="padding:20px 0;">
						<span class="fields boolean field-wrap"><span class="fields boolean field-item">
						<select class="fields boolean" name="UF_DELIVERY_ADDRESS" tabindex="0">
							<option value="0" <?if(empty($arResult["UF_DELIVERY"])):?>selected="selected"<?endif?>>не выбран</option>
							<?foreach ($arResult["DELIVERY"] as $address):?>
								<option value="<?=$address['ID']?>"<?if($arResult["DELIVERY_ADDRESS"]["ID"]== $address['ID']):?>selected="selected"<?endif?>><?=$address['NAME']?></option>
							<?endforeach?>
						</select>
						</span>
						</span>							
...
<div class="profile-link profile-user-div-link">
			<a title="Показать / Скрыть" href="javascript:void(0)" onclick="SectionClick('limit')">Лимит на дни недели</a>
</div>

<div id="user_div_limit" class="profile-block-hidden">
	<table class="data-table profile-table">
		<tbody>
			<?if($arResult["UF_LIMIT_MO"]):?>
				<tr>
					<td class="field-name">Лимит на понедельник</td>
					<td class="field-value">
							<?$APPLICATION->IncludeComponent(
							"bitrix:system.field.edit",
							$arUserField["USER_TYPE"]["USER_TYPE_ID"],
							array("bVarsFromForm" => $arResult["bVarsFromForm"], "arUserField" => $arResult["UF_LIMIT_MO"]), null, array("HIDE_ICONS"=>"Y"));?>
					</td>
				</tr>
			<?endif?>

			<?if($arResult["UF_LIMIT_TU"]):?>
				<tr>
					<td class="field-name">Лимит на вторник</td>
					<td class="field-value">
							<?$APPLICATION->IncludeComponent(
							"bitrix:system.field.edit",
							$arUserField["USER_TYPE"]["USER_TYPE_ID"],
							array("bVarsFromForm" => $arResult["bVarsFromForm"], "arUserField" => $arResult["UF_LIMIT_TU"]), null, array("HIDE_ICONS"=>"Y"));?>
					</td>
				</tr>
			<?endif?>

			<?if($arResult["UF_LIMIT_WE"]):?>
				<tr>
					<td class="field-name">Лимит на среду</td>
					<td class="field-value">
							<?$APPLICATION->IncludeComponent(
							"bitrix:system.field.edit",
							$arUserField["USER_TYPE"]["USER_TYPE_ID"],
							array("bVarsFromForm" => $arResult["bVarsFromForm"], "arUserField" => $arResult["UF_LIMIT_WE"]), null, array("HIDE_ICONS"=>"Y"));?>
					</td>
				</tr>
			<?endif?>

			<?if($arResult["UF_LIMIT_TH"]):?>
				<tr>
					<td class="field-name">Лимит на четверг</td>
					<td class="field-value">
							<?$APPLICATION->IncludeComponent(
							"bitrix:system.field.edit",
							$arUserField["USER_TYPE"]["USER_TYPE_ID"],
							array("bVarsFromForm" => $arResult["bVarsFromForm"], "arUserField" => $arResult["UF_LIMIT_TH"]), null, array("HIDE_ICONS"=>"Y"));?>
					</td>
				</tr>
			<?endif?>

			<?if($arResult["UF_LIMIT_FR"]):?>
				<tr>
					<td class="field-name">Лимит на пятница</td>
					<td class="field-value">
							<?$APPLICATION->IncludeComponent(
							"bitrix:system.field.edit",
							$arUserField["USER_TYPE"]["USER_TYPE_ID"],
							array("bVarsFromForm" => $arResult["bVarsFromForm"], "arUserField" => $arResult["UF_LIMIT_FR"]), null, array("HIDE_ICONS"=>"Y"));?>
					</td>
				</tr>
			<?endif?>

			<?if($arResult["UF_LIMIT_SA"]):?>
				<tr>
					<td class="field-name">Лимит на субботу</td>
					<td class="field-value">
							<?$APPLICATION->IncludeComponent(
							"bitrix:system.field.edit",
							$arUserField["USER_TYPE"]["USER_TYPE_ID"],
							array("bVarsFromForm" => $arResult["bVarsFromForm"], "arUserField" => $arResult["UF_LIMIT_SA"]), null, array("HIDE_ICONS"=>"Y"));?>
					</td>
				</tr>
			<?endif?>


			<?if($arResult["UF_LIMIT_SU"]):?>
				<tr>
					<td class="field-name">Лимит на воскресенье</td>
					<td class="field-value">
							<?$APPLICATION->IncludeComponent(
							"bitrix:system.field.edit",
							$arUserField["USER_TYPE"]["USER_TYPE_ID"],
							array("bVarsFromForm" => $arResult["bVarsFromForm"], "arUserField" => $arResult["UF_LIMIT_SU"]), null, array("HIDE_ICONS"=>"Y"));?>
					</td>
				</tr>
			<?endif?>
