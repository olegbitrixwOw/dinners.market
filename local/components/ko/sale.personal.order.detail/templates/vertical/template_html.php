						...
						<div class="sale-order-detail-order-section bx-active">
							<div class="sale-order-detail-order-section-content container-fluid">
								...
								<div class="small_basket_hover_block">
										<div class="small_basket_overflow" data-test="test">
                                    ...
                                    <tbody>
					                    ...
					                    <td class="small_basket_hover_img">
					                        	                    <a href="/catalog/pizza/tovar_9/" title="Простая пицца 6" style="background-image: url('/upload/resize_cache/iblock/9c8/70_70_2/9c8b629ed8a697efdc75285254232f6d.jpg')"></a>
					                    </td>
					                    <td class="small_basket_hover_name">
					                        <div class="name"><a href="/catalog/pizza/tovar_9/" title="Простая пицца 6">                            Простая пицца 6                            </a></div>
					                        <div class="props">
					                                                    </div>
					                        <div class="item_quantity small_basket_hover_quantity" data-cart-id="bx_basketkVXCwi" data-siteid="s1" data-ajax-path="/local/components/alex/sale.basket.basket.linetmp/ajax.php" data-template-name="vertical">
					                            <a class="minus" href="javascript: void(0);" data-cart-id="bx_basketkVXCwi">
					                            </a><a class="minus" href="javascript: void(0);">-</a><input type="text" class="buy_button_a small-basket-quantity" data-ratio="1" value="1" name="QUANTITY_501" data-id="501" data-path="/local/components/alex/sale.basket.basket.linetmp/templates/vertical/ajax.php" id="12"><a class="plus" href="javascript: void(0);">+</a>
					                        </div>
					                        <div class="small_basket_hover_price">
					                            390 руб                        </div>
					                    </td>
					                    <td class="small_basket_hover_delete"><a href="javascript:void(0);" class="small_basket_hover_delete_action" data-id="501"></a></td>
					                    </tr>
