...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		{	// !!!
			...
			if(errors == 'TIME'){
				this.showError(this.mainErrorsNode, 'Время ормления заказов закончилось!');
				return;
			}
		...
		checkPreload: function(node)
		{
			...
			switch (node.id)
			{
				...
				case this.paySystemBlockNode.id:
					...
					// console.log(this.result.LAST_ORDER_DATA.PAY_SYSTEM);
					// console.log(this.result.LAST_ORDER_DATA.PAY_SYSTEM);
					// console.log(status);
					break;
				case this.deliveryBlockNode.id:
		...
		getBlockFooter: function(node) 	
		{
			...
			if (!isLastNode)
			{
				...
				buttons.push(
					BX.create('A', {
						props: {
							// attrs: {'id': 'create_order'},
							id: 'create_order',
							href: 'javascript:void(0)',
							className: 'btn btn-lg btn-order-save pull-right btn-default'
						},
		...
		editSection: function(section)
		{
			...
			switch (section.id)
			{
				...
				case this.regionBlockNode.id:
					...
					break;
				case this.paySystemBlockNode.id:
					// console.log(this.paySystemBlockNode.id); // !!!
		...
		editActivePaySystemBlock: function(activeNodeMode)
		{
			...
			// console.log(paySystemNode);
			// console.log(paySystemContent);
		},
		...
		{	
			...
			// console.log(selectedPaySystem);
			// console.log(selectedPaySystem.NAME);
			// console.log(addedHtml);
			// console.log(this.isSelectedInnerPayment());
		},
