		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				if($arItem = $dbItems->Fetch()) {
					   ...
					   // // есть ли подразделы
					   // echo ($arItem['RIGHT_MARGIN'] - $arItem['LEFT_MARGIN']) > 1 ? 'подразделы есть ' : 'подразделов нет ';
					   // // определение кол-ва подразделов
					   // $iSubCnt = ceil(($arItem['RIGHT_MARGIN'] - $arItem['LEFT_MARGIN']) / 2) - 1;
					   // echo 'Количество подразделов: '.$iSubCnt;
