...
if(isset($arResult["DISPLAY_PROPERTIES"]["DOCUMENTS"]["VALUE"]) && is_array($arResult["DISPLAY_PROPERTIES"]["DOCUMENTS"]["VALUE"])){
	    foreach($arResult["DISPLAY_PROPERTIES"]["DOCUMENTS"]["VALUE"] as $FILE)
	    {
