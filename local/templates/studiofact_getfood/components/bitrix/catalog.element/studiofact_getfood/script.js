(function(window){
	...
	window.JCCatalogElement.prototype = {
		...
		fillBasketProps: function()
		{
			...
			this.basketParams['quantity'] = $('.item_quantity input').val();
		...
		sendToBasket: function() 
		{
			...
			// console.log(this.visual.BIG_SLIDER_ID);
		...
		{	
			...
			else
			{
				...
				if (arResult.STATUS === 'OK')
				{
					parent.BX.onCustomEvent('OnBasketChange');
					switch (this.productType)
					{
						case 1: // product
						case 2: // set
				...
				// this.obPopupWin.setButtons(popupButtons);
				// this.obPopupWin.show();
				const fancybox = document.querySelector('.fancybox-close-small');
				fancybox.click();
		...
		{
            top.window.location.href = (this.basketData.basketUrl ? this.basketData.basketUrl : BX.message('BASKET_URL'));
		},
