...
<div class="catalog_section scroll-delivery" data-entity="<?=$containerName?>">
	<div class="section_box clearfix bx_catalog_list_home bx_blue no-border">
		<div class="_scroll-standard">
			<div class="section adaptive_scroll_slider" id="section_<?=$arParams['SLIDER_ID'];?>">
				<?
...
$GLOBALS['jsCarouselCode'] .= "var " . $obName . " = new JCCatalogSectionComponent({
	siteId: '" . CUtil::JSEscape(SITE_ID) . "',
	componentPath: '" . CUtil::JSEscape($componentPath) . "',
	navParams: " . CUtil::PhpToJSObject($navParams) . ",
	deferredLoad: false, // enable it for deferred load
	initiallyShowHeader: " . (!empty($arResult["ITEM_ROWS"]) ? 'true' : 'false') . ",
...
$arResult['jsCarouselCode'] = $GLOBALS['jsCarouselCode'];
$cp = $this->__component;
if (is_object($cp)) {
