...
<div class="catalog_section">
	<div class="section clearfix bx_catalog_list_home bx_blue" data-entity="<?=$containerName?>">
		<h2>Блюда доступные для покупки в <?=$day?></h2>
		<?
		...
		{
			if (!isset($arParams['IS_SECTION']) || $arParams['IS_SECTION'] != 'Y') // åñëè òîâàðû íå îòíîñÿòñÿ ê ðàçäåëó êàòàëîãà
			{
...
if ($arParams['HIDE_SECTION_DESCRIPTION'] !== 'Y')
{
	...
	if ((CGetfood::getOption("BANNERS") == 'true') && strlen($arResult["DETAIL_PICTURE"]["SRC"]) > 0)
	{
