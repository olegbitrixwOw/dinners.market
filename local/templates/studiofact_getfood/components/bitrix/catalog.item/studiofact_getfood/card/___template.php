...
<!-- 
	<div class="hover_over">
		<a href="javascript:;" data-width="810" data-fancybox="group" data-src="/catalog/popup/detail_product_page.php?open_popup=Y&day_week=<?//=$arParams["DAY_WEEK"];?>&id=<?//=$item["ID"];?>" class="open_fancybox" rel="gallery">
			<?//=Loc::getMessage("CT_BCI_TPL_MESS_FAST_VIEW");?> 
		</a>
	</div> -->
</div>
		...
		<div class="bx_catalog_item_controls align-items-center">
			...
			<div class="buy_box fr" data-entity="buttons-block">
				...
				if (!$haveOffers)
				{
					...
					if ($actualItem['CAN_BUY'] && $arResult['DAY_WEEK'])
					{
						?>
