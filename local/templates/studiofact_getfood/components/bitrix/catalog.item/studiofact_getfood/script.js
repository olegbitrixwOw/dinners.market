(function (window){
	...
	window.JCCatalogItem.prototype = {
		...
		checkDay: function(){
			const current_day = document.querySelector('#current_day').dataset.day;
			const element = document.querySelector('#'+current_day);
			if(element.dataset.basketorder){
				$('#init_banned_basket').click();
				return element.dataset.basketorder;
			}
			return false;
		},
		...
		sendToBasket: function() 
		{
			...
			// console.log(this.basketParams);
			// console.log(this.visual.DAY_WEEK);
