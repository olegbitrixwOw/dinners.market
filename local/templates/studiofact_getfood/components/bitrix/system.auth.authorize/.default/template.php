...
<div class="bx-auth box padding margin">
	<? 
...
<?endif?>
			<tr>
				<td colspan="2" align="center" class="authorize-submit-cell"><input type="submit" name="Login" value="<?=GetMessage("AUTH_AUTHORIZE")?>" /></td>
			</tr>
		</table>
		...
		<noindex>
			<br />
			<p>
				<?if ($arParams["NOT_SHOW_LINKS"] != "Y"):?><nobr><a href="<?=$arResult["AUTH_FORGOT_PASSWORD_URL"]?>" rel="nofollow"><?=GetMessage("AUTH_FORGOT_PASSWORD_2")?></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</nobr><?endif?>
