...
$(document).on("click", ".item_quantity a.plus, .item_quantity a.minus", function (event) {
        console.log('item_quantity');
...
$(document).on("change", ".bx_catalog_list_home .bx_catalog_item_controls input[type=text]", function (event) {
        console.log('change');
});