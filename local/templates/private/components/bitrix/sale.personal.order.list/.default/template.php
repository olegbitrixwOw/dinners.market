							...
							<div class="row sale-order-list-inner-row">
								...
								<div class="sale-order-list-inner-row-body">
									<div class="col-md-9 col-sm-8 col-xs-12 sale-order-list-payment">
										...
										<?$deliveryPrice = deliveryPrice($payment['ORDER_ID']);?>
										<?if($deliveryPrice):?>
											<div class="sale-order-list-payment-price">  							
											...
											<div class="sale-order-list-payment-price">
												<span class="sale-order-detail-about-order-inner-container-status-detail">Общая стоимость заказа: <?=$deliveryPrice + $payment['FORMATED_SUM']?> руб</span>
											</div>
										<?endif?>
										<?
										if ($payment['PAID'] !== 'Y')
